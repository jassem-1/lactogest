...
export type SheetProps = React.ComponentPropsWithoutRef<typeof Sheet>;
...
export type SheetHeaderProps = React.ComponentPropsWithoutRef<
  typeof SheetHeader
>;
...
export type SheetTitleProps = React.ComponentPropsWithoutRef<typeof SheetTitle>;
